...
Step31最终审计显示，第三问核心文件无缺失，数据一致性通过，核心AI风险表与论文正文保留边界声明，最终审计无FAIL；审计状态统计为 PASS=53，WARNING=7，FAIL=0。
...
|论文|F1_score|F2_key_score|Q_cur_baseline|基线相对等级（封版聚类）|
|---|---|---|---|---|
...
|论文|修改前分|预测修改后分|预测提升|预测达标等级（固定阈值）|稳健达到合格比例|
|---|---|---|---|---|---|
