...
8. total_chars and page_count represent information-carrying amount/completeness, not longer-is-better.
9. There are multiple high-influence samples, so conclusions should be conservative.
10. Small-sample stability is auditable but limited.
